<template>
    <button v-if="!token" @click="getToken" class="gsi-material-button">
    ...
    <button v-if="token" @click="revokeToken">log out</button>
</template>
<script setup>  
    let clientId = ""
    ...
    onMounted(async () => {
        clientId = "571993709984-1dc53moo6eu89rsl7mu31smbvl8tfg7a.apps.googleusercontent.com"
